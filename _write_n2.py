...
export function registerN2Tool(ctx: Context) {
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      latitude: { type: 'number', required: false, description: 'Latitude in degrees (default 0)' }
    },
...
pathlib.Path('src/tools/n2.ts').write_text(code, encoding='utf-8')
print('n2.ts written OK')